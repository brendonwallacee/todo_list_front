import { TrashIcon, ChevronDoubleRightIcon, ChevronDoubleLeftIcon } from "@heroicons/react/16/solid";
...
export default function Card({ id, title, description, state, onChangeState }: CardProps) {
  ...
  return (
    <div className="relative flex flex-col p-2 w-[95%] bg-white rounded-sm shadow-lg dark:bg-gray-800">
      ...
      <button onClick={lixo}>
        < TrashIcon className="absolute top-2 right-2 w-4 h-4 hover:text-red-800" /></button>
